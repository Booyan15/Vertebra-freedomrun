...
const exerciseBase = [
  {
    ...
    area: 'стапало',
    instruction:
      'Застанете стабилно. Подигнете се на прсти, потоа спуштете се и нежно притиснете со целото стапало.',
    duration: '8–10 повторувања по стапало',
    why:
      'Ја активира мускулатурата на стапалото, ја подобрува стабилноста и го оптимизира контактот при трчање.',
    expectedFrames: 5,
  ...
  },
  {
    ...
    why:
      'Го зголемува опсегот на движење и помага чекорот да биде полесен и постабилен.',
    expectedFrames: 5,
    view: 'lower-body close-up'
  },
  {
    ...
    area: 'листови',
    instruction:
      'Подигнете се на прсти, задржете кратко, па контролирано спуштете ги петиците.',
  ...
  },
  {
    ...
    why:
      'Задната ложа помага при стабилност на ногата. Го подобрува опсегот на движење и помага за стабилно и ефикасно трчање.',
    expectedFrames: 5,
    view: 'side view'
  },
  {
